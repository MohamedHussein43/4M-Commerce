...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <!-- Styles -->
        <style src="https://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/css/bootstrap-combined.min.css">
    ...
    <body class="antialiased">
        <div style="margin-top: 10%;margin-left: 15%;" class="section-1-container section-container">
                    ...
                    <div class="col-4 col-md-2 col-lg-6">
                        <form class="row g-3"action="<?php echo e(route('register')); ?>"method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary" id="btnSubmit" type="submit" onclick="return checkPasswordMatch()">Register</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php /**PATH C:\wamp64\www\E-commerce4\resources\views/FrontEnd/register.blade.php ENDPATH**/ ?>