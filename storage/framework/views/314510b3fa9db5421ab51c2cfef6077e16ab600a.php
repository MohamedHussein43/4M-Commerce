                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="fname" value="<?php echo e($user['first_name']); ?>" wire:model="firstname">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="lname" value="<?php echo e($user['last_name']); ?>" wire:model="lastname">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="email" name="email" value="<?php echo e($user['email']); ?>" wire:model="email">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="number" name="phone" value="<?php echo e($user['phone']); ?>" wire:model="mobile">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(Session::has('checkout')): ?>
                            <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">$<?php echo e(Cart::total()); ?></span></p>
                        <?php endif; ?>
...
<?php /**PATH C:\wamp64\www\E-commerce4\resources\views/livewire/checkout-component.blade.php ENDPATH**/ ?>