                        ...
                        <div class="row m-l-0 m-r-0">
                            ...
                            <div class="col-sm-8">
                                <div class="card-block">
                                    <form action="<?php echo e(route('edit-profile')); ?>" method="post" name="frm-edit" autocomplete="off" >
...
unset($__errorArgs, $__bag); ?></span>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input class="text-muted f-w-400 form-control" id="validationDefault01" required name="first_name" value="<?php echo e($user->first_name); ?>" wire:model="first_name">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="validationDefault02" class="m-b-10 f-w-600 form-label">Last Name</label>
                                            <input class="text-muted f-w-400 form-control" id="validationDefault02" required name="last_name" value="<?php echo e($user->last_name); ?>" wire:model="last_name">

                                        </div>
                                        <div class="col-sm-6">
                                            <label class="m-b-10 f-w-600 form-label" for="validationDefaultUsername">Email</label>
                                            <input class="text-muted f-w-400 form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required name="email" value="<?php echo e($user->email); ?>" wire:model="email">

                                        </div>
                                        <div class="col-sm-6">
                                            <label class="m-b-10 f-w-600 form-label">Phone</label>
                                            <input class="text-muted f-w-400 form-control" id="validationDefault02" required name="phone" value="<?php echo e($user->phone); ?>" wire:model="phone">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <h6 class="text-muted f-w-400"><?php echo e($order); ?></h6>
                                        </div>
                                        <div class="col-sm-6">
...
<?php /**PATH C:\wamp64\www\E-commerce4\resources\views/livewire/edit-profile-component.blade.php ENDPATH**/ ?>