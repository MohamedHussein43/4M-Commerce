...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/adminPanel.css')); ?>">
                    ...
                    <div class="topbar-menu right-menu">
                        <ul>
                            <?php if(Session::has('loginId')): ?>
                                    <?php if(Session::get('utype')=='ADM'): ?>
                                        <li class="menu-item menu-item-has-children parent" >
                                            <a title="My Account" href="#">My Account(<?php echo e(Session::get('first_name')); ?>)<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                    <a title="Profile" href="<?php echo e(route('profile')); ?>">Profile</a>
                                                </li>
                                                <li class="menu-item" >
                                                    <a title="Dashboard" href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
                                                </li>
                                                <li class="menu-item">
                                                ...
                                                <li class="menu-item" >
                                                    <a title="Register or Login" href="<?php echo e(route('logout')); ?>">Logout</a>
                                                </li>
                                            </ul>
                                        </li>
                                    ...
                                    <?php else: ?>
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                ...
                                                <li class="menu-item" ><a title="Register or Login" href="<?php echo e(route('logout')); ?>">Logout</a></li>
                                            </ul>
                                        </li>
                                    <?php endif; ?>

                            <?php else: ?>
                                <li class="menu-item" ><a title="Register or Login" href="<?php echo e(route('login-user')); ?>">Login</a></li>
                                <li class="menu-item" ><a title="Register or Login" href="<?php echo e(route('register-user')); ?>">Register</a></li>
                            <?php endif; ?>
            ...
            <div class="container">
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-logo-top left-section">
                        <a href="/" class="link-to-home"><img src="<?php echo e(asset('assets/images/fcihcommerce-logo.png')); ?>" style="border-radius: 20%" alt="mercado"></a>
                    </div>

                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('header-search-component')->html();
} elseif ($_instance->childHasBeenRendered('kRKvUnn')) {
    $componentId = $_instance->getRenderedChildComponentId('kRKvUnn');
    $componentTag = $_instance->getRenderedChildComponentTagName('kRKvUnn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kRKvUnn');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('kRKvUnn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\wamp64\www\E-commerce4\4M-Commerce\resources\views/layouts/base.blade.php ENDPATH**/ ?>